...
import unispark.mobile.view.details.DetailsCourseView;
import unispark.mobile.view.professor.ProfessorProfileView;
...
public class ManageProfessorProfileGuiController extends ProfBaseGuiController {
    ...
    public void showAddExam(){
        ...
        fragment.show(this.profileView.getSupportFragmentManager(), "AddExamAppController");
    }

    public void showAddHomework(){
        AddHomeworkView fragment= new AddHomeworkView(session, null, null);
        fragment.show(this.profileView.getSupportFragmentManager(), "AddHomeworkAppController");
    }
