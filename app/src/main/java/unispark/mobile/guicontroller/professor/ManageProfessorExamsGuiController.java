...
import unispark.mobile.view.professor.VerbalizeExamsView;
import unispark.mobile.view.professor.ProfessorExamsView;
...
public class ManageProfessorExamsGuiController extends ProfBaseGuiController {
    ...
    public void showAddExam(){
        ...
        fragment.show(this.examsView.getSupportFragmentManager(), "AddExamAppController");
    }

    public void showAddHomework(){
        AddHomeworkView fragment= new AddHomeworkView(session, null, null);
        fragment.show(this.examsView.getSupportFragmentManager(), "AddHomeworkAppController");
    }
